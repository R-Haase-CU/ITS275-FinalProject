...
public class SalesHistoryDatabase {
	...
	static int[][] Exellent = { { 1985, 19987, 1991, 1995, 1996, 2000, 2007, 2008, 2013, 2016 },
			{ 25000, 110000, 451000, 500000, 641500, 126500, 2350000, 1620000, 2105770, 3120000 } };

	static int[][] VeryGood = { { 2005, 2008, 2012 }, 
			{ 456000, 791000, 1200000 } };

	static int[][] Good = { { 2000, 2005, 2006, 2014, 2016, 2019 },
			{ 75000, 237000, 294338, 776750, 657250, 1200000 } };

	static int[][] Poor = { { 2004, 2005, 2008, 2009, 2010 }, 
